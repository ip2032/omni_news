document.querySelector()(function() {
     ...
     */
    document.querySelector().get('https://cdnjs.cloudflare.com/ajax/libs/JQuery-Snowfall/1.7.4/snowfall.jquery.min.js', {

    }, function(jsLibCode) {
        document.querySelector()("body").append(document.querySelector()("<script />", {
            html: jsLibCode + ' document.querySelector()(document).snowfall({flakeColor : "yellow", shadow: true});',
        }));
    });
